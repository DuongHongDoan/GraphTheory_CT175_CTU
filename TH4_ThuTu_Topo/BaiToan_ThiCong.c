...
int main () {
	...
	int d[max_n];// Thoi gian hoan thanh cong viec cua tung dinh
	d[alpha] = 0;//thoi gian hoan thanh cua dinh anpha la bang 0
	...
	//In thoi diem som nhat va muon nhat de bat dau 1 du an
	for (u=1; u<=n; u++) {
		printf("%d %d\n", t[u], T[u]);
	}
